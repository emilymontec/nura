...
# Agregar la carpeta services al path para poder importar las apps
...
ROOT_URLCONF = 'config.nura_config.urls'
...
WSGI_APPLICATION = 'config.nura_config.wsgi.application'
