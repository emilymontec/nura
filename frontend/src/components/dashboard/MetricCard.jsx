export default function MetricCard({ label, value, unit, barColor = "bg-nura-electric", barWidth = "w-full", valueColor = "text-white" }) {
  return (
    <div className="pure-glass rounded p-4 font-mono">
      ...
      <div className="w-full bg-white/5 h-0.5 mt-3 overflow-hidden">
        <div className={`${barColor} h-full ${barWidth}`} />
      </div>
    </div>
  );
}
